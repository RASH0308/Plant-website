...
<header>
    ...
    <div class="header-3">
        ...
        <div class="icons">
            ...
            <a href="registra.php" class="fas fa-user-circle"></a>
        </div>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <div class="price">₹220 <span>₹260</span></div>
        <a href="#" class="btn">add to cart</a>
    </div>
    ...
    <div class="box">
        ...
        <div class="price">₹200 <span>₹280</span></div>
        <a href="#" class="btn">add to cart</a>
    </div>
    ...
    <div class="box">
        ...
        <div class="price">₹200 <span>₹270</span></div>
        <a href="#" class="btn">add to cart</a>
    </div>
